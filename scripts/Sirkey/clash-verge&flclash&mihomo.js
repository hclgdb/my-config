...
const ICONS = {
  ...
  X: () => GH_RAW_URL("Koolson/Qure/master/IconSet/Color/X.png"),
  Spotify: () => GH_RAW_URL("Koolson/Qure/master/IconSet/Color/Spotify.png"),
  Pixiv: () => GH_RAW_URL("hclgdb/my-config/main/icons/Pixiv.png"),
...
const URLS = {
  rulesets: {
    ...
    geosite_x: () => GH_RAW_URL("hclgdb/my-config/refs/heads/main/rules/Twitter/Twitter_No_Resolve.yaml"),
...
const Config = {
  ...
  ruleOptions: {
    ...
    youtube: true, bahamut: true, netflix: true, disney: true, pixiv: true,
    hbo: true, biliintl: true, tvb: true, hulu: true, primevideo: true, x: true,
    games: true, japan: true, tracker: true, ads: true
  },
  preRules: [
  ...
  services: [
    ...
    { id: "x", rule: ["GEOSITE,twitter,X", "RULE-SET,geosite-twitter,X"], name: "X", url: "https://x.com/", icon: ICON_VAL(ICONS.X), ruleProvider: {name: "geosite-twitter", url: URLS.rulesets.geosite_x(), format: "yaml", behavior: "domain"} },
